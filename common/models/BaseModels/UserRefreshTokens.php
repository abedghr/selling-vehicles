...
class UserRefreshTokens extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\BaseModels\Query\BaseQuery\UserRefreshTokensQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\BaseModels\Query\BaseQuery\UserRefreshTokensQuery(get_called_class());
    }
}
